				...
				<Tall
					...
					slave={
						<>
							<IconCard
								title="Vacuum Repair"
								content="We will diagnose and repair vacuums of all makes and models."
								icon={GiVacuumCleaner}
							/>
							<IconCard
								title="Sewing Machine Repair"
								content="Let us restore your sewing machine and make it work like new."
								icon={GiSewingMachine}
							/>
							<IconCard
								title="Free Estimates"
								content="Bring your appliance to the store or give us a call to get a free estimate."
